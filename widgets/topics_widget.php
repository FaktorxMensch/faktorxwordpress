...
//        print_r($response_body);
    ...
    if ($description === false || isset($_GET['fxwp_website_description_edit'])) {
        echo '<img src="' . plugins_url('../assets/img/robot.jpeg', __FILE__) . '" style="width:calc( 100% + 24px );margin:-12px">';
        echo '<img src="https://faktorxmensch.com/image/brand/logo_dark.svg" style="background:#0003;padding:3px 3px;position:absolute;top:2px;left:12px;width:100px;z-index:31">';
